...
void ThreadMapPort()
{
    ...
    if (r == 1)
    {
        ...
        string strDesc = "TokenOfHope " + FormatFullVersion();
...
static const char *strMainNetDNSSeed[][2] = {
    {"tohcoin.com", "node.tohcoin.com"},
    {"tohcoin.com", "node9.tohcoin.com"},
    {NULL, NULL}
};
...
bool BindListenPort(const CService &addrBind, string& strError)
{
    ...
    if (::bind(hListenSocket, (struct sockaddr*)&sockaddr, len) == SOCKET_ERROR)
    {
        ...
        if (nErr == WSAEADDRINUSE)
            strError = strprintf(_("Unable to bind to %s on this computer. TokenOfHope is probably already running."), addrBind.ToString().c_str());
        else
